...
<header>
    <!-- Top-Header -->
    <div class="full-layer-bottom-header" style="min-height: 10vh;">
        <div class="row align-items-center justify-content-center" style="width: 85vw; margin: 0px auto;">
            <div class="row align-items-center justify-content-between w-100">
                <div class="col-lg-1 col-md-12 flex justify-content-center">
                    <div class="brand-logo text-center flex justify-content-center">
                        <a class="flex justify-content-center" href="{{ url('/') }}">
                            <img src="{{ asset('front/images/main-logo/main-logo.png') }}" style="height: 120px; margin: 0px auto" alt="Multi-vendor E-commerce Application" class="app-brand-logo">
                        </a>
                    </div>
                </div>
                <div class="col-lg-9 d-none d-lg-inline-block">
                    <ul class="bottom-nav row justify-content-center g-nav" style="margin: 10px 0px;">
                        <li>
                ...
                <nav class="col-lg-2">
                    <ul class="secondary-nav g-nav">
                        <li class="button-primary" style=" border-radius: 10px;">
                            <a class="text-white">
                                ...
                                <i class="fas fa-chevron-down u-s-m-l-9 text-white"></i>
                            </a>
    ...
    <div class="full-layer-mid-header">
        <div class="container col-8">
            <div class="row clearfix d-flex justify-content-center align-items-center">
                ...
                <div class="col-sm-9 col-lg-6">
                    ...
                    <form class="form-searchbox" action="{{ url('/search-products') }}" method="get">
                        ...
                        <button id="btn-search" style="border-radius: 7px" type="submit" class="button button-primary fas fa-search"></button>
                    </form>
                    @php
                        // dd($_GET);
                    @endphp
